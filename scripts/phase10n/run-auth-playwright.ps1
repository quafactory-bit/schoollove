...
"@
  ...
  SqlFile (Resolve-Path 'scripts/phase10l/seed-production-shape.sql').Path;SqlFile $reset;SqlFile $launch;SqlFile (Resolve-Path 'scripts/phase10l/postgrest-test-bootstrap.sql').Path
  ...
  $playwrightArgs=@('node_modules/@playwright/test/cli.js','test','e2e/phase10n-account.spec.ts','--workers=1','--retries=0')
