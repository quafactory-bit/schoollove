...
BEGIN
  ...
  INSERT INTO private.oauth_login_attempts(id,safe_attempt_id,provider,state,broker_subject,subject_digest,subject_key_version,account_id,consumed_at) VALUES(source_attempt,'att_10p_activation_race_src','google','consumed',s,d,1,account_id,clock_timestamp());
  target_attempt:=public.create_social_login_attempt('att_10p_activation_race_new','google',clock_timestamp()+interval '10 minutes');
