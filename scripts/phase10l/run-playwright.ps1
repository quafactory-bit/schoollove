...
$env:NEXT_PUBLIC_SUPABASE_ANON_KEY = 'phase10l-local-anon'
$env:SUPABASE_SERVICE_ROLE_KEY = 'phase10l-local-service'
...
try {
  ...
  if ($server.HasExited) { throw 'Next.js PHASE 10L E2E server exited during startup.' }
