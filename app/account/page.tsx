...
export default async function AccountPage() {
  ...
  return <AccountClient state={state} launch={launch} controlledBetaAccess={controlledBetaAccess} peopleSearchBetaAccess={peopleSearchBetaAccess} instagramBetaAccess={instagramBetaAccess} betaOnboardingState={betaOnboardingState} currentYear={getKstCalendarDate().year} />
}
