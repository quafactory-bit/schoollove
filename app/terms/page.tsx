      ...
      <div className="mt-10 space-y-9 text-sm leading-7 text-gray-700">
        <section>
          ...
          <p className="mt-2">
            ...
            사람 찾기는 계정 등록과 별도로 초대·승인된 제한 베타에서만 제공합니다. 학교·졸업연도·정확한 이름이 일치할 때만 안부를 요청할 수 있고, 반 조건은 본인이 저장한 이력과 일치해야 합니다. 공개 명단·부분 이름 검색은 제공하지 않습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            본인 소유권과 기본 비공개를 조건으로 하며 Instagram은 사람 검색이나 공개 화면에 표시하지 않습니다. 수락 전 이름은 마스킹되고, 수락 후 연결 상대에게 표시명이 보입니다. Instagram은 해당 기능 권한이 있는 이용자가 연결 상대별로 별도 공개 승인한 경우에만 보이며 취소할 수 있습니다. 메시지는 현재 제공하지 않습니다.
          </p>
          <p className="mt-2">
