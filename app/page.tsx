...
const stateCopy={
  ...
  open:{label:'성인 비공개 계정 시작',description:'만 19세 이상 본인은 Google 로그인 후 자기 정보만 비공개로 기록할 수 있습니다.',cta:true},
