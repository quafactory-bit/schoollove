...
export const metadata: Metadata = { title: '프로모션 운영 정책', description: '스쿨러브아이 오늘의 인스타그램주소 무료 편집 추천과 유료 프로모션 운영 기준입니다.' }
  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <div className="mt-9 space-y-8 text-sm leading-7 text-gray-700">
        ...
        <section><h2 className="text-lg font-bold text-gray-950">신청 자격과 계정 확인</h2><p className="mt-2">만 19세 이상 로그인 사용자가 본인 계정 또는 검증 가능한 사업자 계정의 인스타그램주소만 신청할 수 있습니다. 임시 프로필 코드로 소유를 수동 확인하며 비밀번호, 세션 쿠키, 로그인 토큰은 받지 않습니다.</p></section>
