...
export default function AdvertisingPolicyPage() {
  return (
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <p className="mt-3 text-sm text-gray-500">시행 예정일: PHASE 10D Production 별도 승인일</p>
      <div className="mt-9 space-y-8 text-sm leading-7 text-gray-700">
        ...
        <p className="border border-amber-200 bg-amber-50 p-4 text-xs text-amber-950">이 문서는 현재 구현과 운영 경계를 설명하는 초안이며 전문 법률 자문을 대체하지 않습니다. Production 적용 전 최종 운영·법률 검토가 필요합니다.</p>
      </div>
    </main>
  )
}
