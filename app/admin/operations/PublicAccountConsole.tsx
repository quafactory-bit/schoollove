...
export default function PublicAccountConsole(){
  ...
  return <section className="space-y-5 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
    <div><h2 className="text-lg font-bold">공개 계정 소프트런치·긴급 중단</h2><p className="mt-2 text-sm text-gray-600">초대 프로그램과 분리된 경계입니다. Production open은 별도 승인과 runbook 실행 전 금지됩니다.</p></div>
