...
export default function LoginPage() {
  return <main className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md items-center px-5 py-10 sm:py-14">
    <section className="w-full" aria-labelledby="login-title">
      ...
      <h1 id="login-title" className="mt-3 text-3xl font-bold tracking-tight text-schoollove-text">Google로 로그인</h1>
      <p className="mt-3 text-sm leading-6 text-schoollove-secondary">개인 기능은 만 19세 이상 본인만 사용할 수 있습니다. Google 로그인 뒤 필요한 경우에만 복구 이메일 확인을 진행합니다.</p>
