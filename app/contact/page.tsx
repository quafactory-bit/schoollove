      ...
      <div className="space-y-6">
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <p className="text-sm text-gray-600 mb-3">아래 이메일로 문의주시면 빠르게 답변드리겠습니다.</p>
            ...
            href="mailto:schoollove.contact@gmail.com"
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <p className="text-sm text-gray-600">
            광고 게재, 학교 커뮤니티 연계, 기타 비즈니스 제휴에 관심 있으신 분들은
            이메일 제목에 <strong>[제휴 문의]</strong>를 포함하여 보내주세요.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          ...
          <p className="text-sm text-gray-600 mb-3">
            본인 정보 삭제를 원하시면 사이트 내 삭제 요청 기능을 이용하거나
            이메일로 문의해주세요.
          </p>
