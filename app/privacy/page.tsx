    ...
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <div className="mt-10 space-y-9 text-sm leading-7 text-gray-700">
        <section>
          ...
          <p className="mt-2">
            스쿨러브아이는 개인의 이름·졸업연도·학년·반·Instagram 정보가 결합된 공개 명단과 공개 사람 검색을 제공하지 않습니다.
            ...
            별도 초대·승인된 제한 베타에서는 학교·졸업연도·정확한 이름의 일치 여부만 확인합니다. 선택한 반 조건은 본인이 저장한 학교 이력과 일치해야 합니다. 개인 명단·검색 결과 수·상대 계정 ID는 반환하지 않습니다. 안부 수락 전 이름은 마스킹되며, 연결 후 상대에게 표시명이 보입니다. Instagram은 기능 권한과 연결 상대별 공개 승인이 있을 때만 보이고 취소·차단·연결 해제 시 비공개로 전환됩니다.
          </p>
        </section>
