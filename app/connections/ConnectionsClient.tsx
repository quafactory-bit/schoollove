...
export default function ConnectionsClient() {
  ...
  return <main className="mx-auto max-w-3xl px-5 py-10">
    ...
    {status && <p role="status" className="sticky bottom-20 mt-5 rounded-xl bg-gray-950 px-4 py-3 text-sm text-white">{status}</p>}
  </main>
}
