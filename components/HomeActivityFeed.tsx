    ...
    <div>
      ...
      {hiddenItems.length > 0 && (
        <details className="group border-t border-schoollove-border">
          <summary className="schoollove-focus flex min-h-11 cursor-pointer list-none items-center justify-between gap-3 py-4 text-[14px] font-semibold text-schoollove-text marker:hidden">
            <span>성장 소식 더 보기</span>
            <span className="font-retro text-[12px] font-normal text-schoollove-electric-blue">
              +{hiddenItems.length}
            </span>
          </summary>
          <div>
