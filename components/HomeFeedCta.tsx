...
export default function HomeFeedCta({ title, buttonLabel, href }: Props) {
  return (
    <div className="my-10 border-y border-schoollove-border py-8 text-center lg:my-12 lg:py-10">
      ...
      <Link
        href={href}
        className="schoollove-dark-action-hover schoollove-focus mt-5 inline-flex min-h-12 min-w-[160px] items-center justify-center border border-schoollove-text px-7 text-[15px] text-schoollove-text transition-colors hover:bg-schoollove-text"
      >
        {buttonLabel}
      </Link>
    </div>
