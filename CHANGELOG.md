...
- Linked only valid DB-derived school slugs to the privacy-safe public school basics page; the public page adds a generic account-management CTA without membership personalization or private queries.
