...
- Added migration `20260729190000_controlled_beta_operations.sql` for setup drafts, operator notes, feedback, tasks, campaigns, masked aggregates, readiness snapshots, RLS/FORCE RLS, and audited service-role RPCs.
...
- Relevant tests passed: 3 files / 16 tests. Full tests passed: 108 files / 998 tests. TypeScript and the 59-page Production build passed.
