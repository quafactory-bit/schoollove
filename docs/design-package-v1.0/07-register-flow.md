...
> **PHASE 10B APPROVED SUPERSESSION (2026-07-28):** 공개 등록은 재개하지 않는다. 이메일 OTP 로그인, KST 만 19세 자기진술, 필수 동의 이후 `/account`에서 본인 소유 private profile 하나와 여러 학교 이력만 관리한다. 사람 발견·메시지·Instagram 승인 공개는 PHASE 10C 전까지 제공하지 않는다.
